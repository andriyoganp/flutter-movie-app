...
class _MovieService implements MovieService {
  ...
  @override
  Future<MovieListDto> getUpcomingMovies({int? page}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'page': page};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<CastListDto> getMovieCredits(int id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<CastListDto>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = CastListDto.fromJson(_result.data!);
    return value;
  }
